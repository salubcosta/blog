<div class="row">
	<div class="col-md-8">
		<div class="p text-muted mt-3 text-justify">
			<h4 class="mb-3">Sobre o autor: XD</h4>
			<p class="mb-0 mb-3">Meu nome é Salumão Barbosa da Costa, sou bacharel em Sistemas de Informação e especialista em engenharia de Software. Ora bla bla bla área da tecnologia da informação, programação, banco de dados e outros tópicos como resumos de artigos, posts com questões, mapas mentais, um verdadeiro acervo pessoal para estudo.</p>
	  		<p>
